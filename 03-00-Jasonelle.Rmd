...
|  Name | Photo | Role  | Years |
|  ---  |  ---  |  ---  |  ---  |
| [Christian Swanepoel](https://github.com/christianswanepoel) | ![](https://avatars1.githubusercontent.com/u/7249713?s=100&v=4) | `Blaze` (iOS, Android, Testing) | 2019 - present |
| [Al Sanchez](https://www.stackk.xyz/) | ![](https://user-images.githubusercontent.com/292738/62412952-431bc400-b5d7-11e9-80d3-88de9cb67078.jpg) | `Blaze` (Desing, Testing) | 2019 - present |
...
A blaze collaborator is a trusted member of the community. 
...
A `Blaze` is not required to participate actively. But if more than `6 months`
...
want to help but don't want to go full you can be a `Blaze` collaborator.
...
with your ideas and why you should be a `Forgemaster` or `Blaze`.
